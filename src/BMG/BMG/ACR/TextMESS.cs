...
namespace BMG.ACR
{
    public class TextMESS: BMG
    {
        public const string FileTitle = "TEXT.MESS";

        public override string FileType
        {
            get { return "Another Code R - TEXT.MESS"; }
        }
        ...
        public TextMESS(Sentence_Text[] ss)
        {
            Sentences = ss;
        }

        public TextMESS(string filename, bool rawBmg)
        {
            if (rawBmg)
            {
        ...
        private void ReadXmlFile(string filename)
        {
            ...
            Sentences = new Sentence_Text[sentenceNodes.Count];

            int i = 0;
            foreach (XmlElement element in sentenceNodes)
            {
                Sentences[i++] = new Sentence_Text(element);
            }
        ...
        private void ReadBMGFile(string filename)
        {
            ...
            using (FileStream stream = new FileStream(filename, FileMode.Open))
            {
                ...
                Sentences = new Sentence_Text[count];
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    Sentence_Text sen = new Sentence_Text(binData);
        ...
        public override void WriteSessionXml(string filename)
        {
            ...
            int i = 0;
            foreach (Sentence_Text sentence in Sentences)
            {
